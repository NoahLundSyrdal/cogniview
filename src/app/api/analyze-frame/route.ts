...
- If the screen appears unchanged, set actionItems to [] unless a clearly new task appears now.
- Do not restate or paraphrase tasks already implied by previous context.
